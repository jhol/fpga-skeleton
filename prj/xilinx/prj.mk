...
SRC_DIR = $(ROOT_DIR)/prj/src
SCRIPTS_DIR = $(ROOT_DIR)/prj/scripts
XILINX_PRJ_DIR = $(ROOT_DIR)/prj/xilinx
...
#all: $(XILINX_PRJ_FILES) $(XILINX_XST_FILES)

#clean:
#	rm -rf $(XILINX_PRJ_DIR)/*.prj  $(XILINX_PRJ_DIR)/*.xst
